...
echo 7 - DeepSeek-R1-Distill-Qwen-1.5B-Q6_K.gguf
echo 8 - qwen2.5-1.5b-instruct-q5_k_m.gguf
echo 9 - smollm2-1.7b-instruct-q4_k_m.gguf
echo 0 - EXIT
...
start cmd.exe /k "%SRV%\llama-server.exe -m %DML%\DeepSeek-R1-Distill-Qwen-1.5B-Q6_K.gguf -c 15000 -ngl 999"
goto :START

:MODEL8
cls
echo Starting llama-server API for qwen2.5-1.5b-instruct-q5_k_m.gguf
start cmd.exe /k "%SRV%\llama-server.exe -m %DML%\qwen2.5-1.5b-instruct-q5_k_m.gguf -c 15000 -ngl 999"
goto :START

:MODEL9
cls
echo Starting llama-server API for smollm2-1.7b-instruct-q4_k_m.gguf
start cmd.exe /k "%SRV%\llama-server.exe -m %DML%\smollm2-1.7b-instruct-q4_k_m.gguf -c 8192 -ngl 999"
goto :START
